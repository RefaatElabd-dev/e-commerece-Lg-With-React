          ...
          <div className="row m-0 p-0">
            <div className="col-md-3">
              <nav className="navbar  bg-white">
                ...
                {this.state.Catbrands && <>  <li className="nav-item mt-2  mb-2">
                    Brand
                  </li>
                  <li className="nav-item ml-3 ni">

                    {this.state.Catbrands.map((c, i) => <div key={i}><input value={c.brandId} name="brand" type="checkbox"  onChange={this.handlechecked}  /> {c.brandName}</div>)}
                  ...
                  <div className="dropdown-divider" />
                {this.state.sizes && <> <li className="nav-item mt-2  mb-2">
                    SIZE
                  </li>
                  <li className="nav-item ml-3 ni">
